        ...
        <Grid container height = "100vh"> 
            <Grid item xs = {11} sm = {8} md = {6} xl = {4} margin = "auto">
                <Stack direction = "column" alignItems = "center" spacing = {2}>
                    ...
                    <Typography variant ="h4" component = "h1" align = "center">{props?.titulo}</Typography>
                    <Typography variant ="subtitle1" component = "p" align = "center">{props?.subtitulo}</Typography>
                    <Typography variant ="body1" component = "p" align = "center">{props?.descricao}</Typography>
